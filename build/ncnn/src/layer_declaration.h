...
namespace ncnn {
class GELU_final : virtual public GELU, virtual public GELU_arm
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = GELU::create_pipeline(opt); if (ret) return ret; }
        { int ret = GELU_arm::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = GELU_arm::destroy_pipeline(opt); if (ret) return ret; }
...
#include "layer/relpositionalencoding.h"
namespace ncnn {
class RelPositionalEncoding_final : virtual public RelPositionalEncoding
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = RelPositionalEncoding::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = RelPositionalEncoding::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(RelPositionalEncoding_final)
} // namespace ncnn

#include "layer/makepadmask.h"
namespace ncnn {
class MakePadMask_final : virtual public MakePadMask
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = MakePadMask::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = MakePadMask::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(MakePadMask_final)
} // namespace ncnn

#include "layer/relshift.h"
namespace ncnn {
class RelShift_final : virtual public RelShift
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = RelShift::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = RelShift::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(RelShift_final)
} // namespace ncnn
...
#include "layer/lstm2.h"
namespace ncnn {
class LSTM2_final : virtual public LSTM2
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = LSTM2::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = LSTM2::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(LSTM2_final)
} // namespace ncnn
